...
export const initialTeamMembers: TeamMember[] = [
  {
    ...
    bio: 'Co-Founder at Zynthax Digital Solutions. Focused on software architecture, full-stack web platforms, and custom business systems.',
  ...
  },
  {
    ...
    bio: 'Co-Founder at Zynthax Digital Solutions. Focused on engineering systems, product strategy, and modern digital applications.',
    photoUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=800&q=80',
    photoPublicId: 'zynthax/team/irene_sabu',
    portfolioLinks: [
